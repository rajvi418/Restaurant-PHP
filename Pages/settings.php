        ...
        <section class="content-container">
            <section class="setting-options">
                <div class="settings-header">
                    <h3 class="title">Settings & Preferences</h3>
                </div>
                <div class="options-container">
                    <div class="option">
                        ...
                        <button class="universal-btn">Manage</button>
                    </div>
                    <div class="option">
                        <div class="settings-title">
                    ...
                    <div class="option">
                        <div class="settings-title">
                            ...
                            <p>Adjust your privacy preferences and data sharing options.</p>
                        </div>
                        <button class="universal-btn">Manage</button>
                    </div>
                    <div class="option">
                    ...
                    <div class="option">
                        <div class="settings-title">
                            ...
                            <p>Choose between light and dark mode for the application.</p>
                        </div>
                        <button class="universal-btn">Manage</button>
                    </div>
